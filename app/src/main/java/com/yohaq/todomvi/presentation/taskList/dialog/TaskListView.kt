            ...
            is TaskListState.TasksLoaded ->
                TaskListViewState(
                        tasks = tasks
                                .map {
                                    when (it) {
                                        is TaskItemState.CompletedTask ->
                                            TaskItemViewState(
                                        ...
                                        is TaskItemState.IncompleteTask ->
                                            TaskItemViewState(
                                                    isComplete = it.task.isComplete,
                                                    isCheckEnabled = true,
                                        ...
                                        is TaskItemState.AddTaskFailure ->
                                            TaskItemViewState(
                                                    isComplete = false,
                                                    isCheckEnabled = false,
                                                    isProgressSpinnerVisible = false,
                                        ...
                                        is TaskItemState.MarkTaskCompleteFailure ->
                                            TaskItemViewState(
                                                    isComplete = false,
                                                    isCheckEnabled = false,
                                                    isProgressSpinnerVisible = false,
                                        ...
                                        is TaskItemState.MarkTaskIncompleteFailure ->
                                            TaskItemViewState(
                                                    isComplete = true,
                                                    isCheckEnabled = false,
                                                    isProgressSpinnerVisible = false,
                                        ...
                                        is TaskItemState.MarkingTaskComplete ->
                                            TaskItemViewState(
                                                    isComplete = true,
                                                    isCheckEnabled = false,
                                                    isTitleEnabled = false,
                                        ...
                                        is TaskItemState.MarkingTaskIncomplete ->
                                            TaskItemViewState(
                                                    isComplete = false,
                                                    isCheckEnabled = false,
                                                    isTitleEnabled = false,
